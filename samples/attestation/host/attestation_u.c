    ...
    size_t* format_settings_size)
{
    ...
    _args.format_settings = (uint8_t**)format_settings;
    _args.format_settings_size = (size_t*)format_settings_size;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             attestation_fcn_id_get_enclave_format_settings,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    *_retval = _pargs_out->_retval;
    ...
    OE_READ_OUT_PARAM(format_settings, (size_t)(sizeof(uint8_t*)));
    OE_READ_OUT_PARAM(format_settings_size, (size_t)(sizeof(size_t)));
    ...
    size_t* evidence_buffer_size)
{
    ...
    memset(&_args, 0, sizeof(_args));
    _args.format_id = (oe_uuid_t*)format_id;
    _args.format_settings_buffer = (uint8_t*)format_settings_buffer;
    _args.format_settings_size = format_settings_size;
    _args.pem_key = (uint8_t**)pem_key;
    _args.pem_key_size = (size_t*)pem_key_size;
    _args.evidence_buffer = (uint8_t**)evidence_buffer;
    _args.evidence_buffer_size = (size_t*)evidence_buffer_size;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(get_evidence_with_public_key_args_t));
    if (format_id)
        OE_ADD_SIZE(_input_buffer_size, sizeof(oe_uuid_t));
    if (format_settings_buffer)
        OE_ADD_SIZE(_input_buffer_size, _args.format_settings_size);
    ...
    if (format_id)
        OE_WRITE_IN_PARAM(format_id, sizeof(oe_uuid_t), oe_uuid_t*);
    if (format_settings_buffer)
        OE_WRITE_IN_PARAM(format_settings_buffer, _args.format_settings_size, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             attestation_fcn_id_get_evidence_with_public_key,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    *_retval = _pargs_out->_retval;
    ...
    OE_READ_OUT_PARAM(evidence_buffer, (size_t)(sizeof(uint8_t*)));
    OE_READ_OUT_PARAM(evidence_buffer_size, (size_t)(sizeof(size_t)));
    ...
    size_t evidence_size)
{
    ...
    _args.format_id = (oe_uuid_t*)format_id;
    _args.pem_key = (uint8_t*)pem_key;
    _args.pem_key_size = pem_key_size;
    _args.evidence = (uint8_t*)evidence;
    _args.evidence_size = evidence_size;
    ...
    if (format_id)
        OE_ADD_SIZE(_input_buffer_size, sizeof(oe_uuid_t));
    if (pem_key)
        OE_ADD_SIZE(_input_buffer_size, ((size_t)_args.pem_key_size * sizeof(uint8_t)));
    if (evidence)
        OE_ADD_SIZE(_input_buffer_size, ((size_t)_args.evidence_size * sizeof(uint8_t)));
    ...
    if (format_id)
        OE_WRITE_IN_PARAM(format_id, sizeof(oe_uuid_t), oe_uuid_t*);
    if (pem_key)
        OE_WRITE_IN_PARAM(pem_key, ((size_t)_args.pem_key_size * sizeof(uint8_t)), uint8_t*);
    if (evidence)
        OE_WRITE_IN_PARAM(evidence, ((size_t)_args.evidence_size * sizeof(uint8_t)), uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             attestation_fcn_id_verify_evidence_and_set_public_key,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             attestation_fcn_id_generate_encrypted_message,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             attestation_fcn_id_process_encrypted_message,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t report_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             attestation_fcn_id_oe_verify_report_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             attestation_fcn_id_oe_get_sgx_report_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             attestation_fcn_id_oe_get_report_v2_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             attestation_fcn_id_oe_verify_local_report_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             attestation_fcn_id_oe_sgx_init_context_switchless_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_enclave_worker_context_t* context)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             attestation_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
enum
{
    ...
    attestation_fcn_id_oe_syscall_mkdir_ocall = 29,
    attestation_fcn_id_oe_syscall_rmdir_ocall = 30,
    attestation_fcn_id_oe_syscall_fcntl_ocall = 31,
    attestation_fcn_id_oe_syscall_ioctl_ocall = 32,
    attestation_fcn_id_oe_syscall_poll_ocall = 33,
    attestation_fcn_id_oe_syscall_kill_ocall = 34,
    attestation_fcn_id_oe_syscall_close_socket_ocall = 35,
    attestation_fcn_id_oe_syscall_socket_ocall = 36,
    attestation_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 37,
    attestation_fcn_id_oe_syscall_socketpair_ocall = 38,
    attestation_fcn_id_oe_syscall_connect_ocall = 39,
    attestation_fcn_id_oe_syscall_accept_ocall = 40,
    attestation_fcn_id_oe_syscall_bind_ocall = 41,
    attestation_fcn_id_oe_syscall_listen_ocall = 42,
    attestation_fcn_id_oe_syscall_recvmsg_ocall = 43,
    attestation_fcn_id_oe_syscall_sendmsg_ocall = 44,
    attestation_fcn_id_oe_syscall_recv_ocall = 45,
    attestation_fcn_id_oe_syscall_recvfrom_ocall = 46,
    attestation_fcn_id_oe_syscall_send_ocall = 47,
    attestation_fcn_id_oe_syscall_sendto_ocall = 48,
    attestation_fcn_id_oe_syscall_recvv_ocall = 49,
    attestation_fcn_id_oe_syscall_sendv_ocall = 50,
    attestation_fcn_id_oe_syscall_shutdown_ocall = 51,
    attestation_fcn_id_oe_syscall_setsockopt_ocall = 52,
    attestation_fcn_id_oe_syscall_getsockopt_ocall = 53,
    attestation_fcn_id_oe_syscall_getsockname_ocall = 54,
    attestation_fcn_id_oe_syscall_getpeername_ocall = 55,
    attestation_fcn_id_oe_syscall_getaddrinfo_open_ocall = 56,
    attestation_fcn_id_oe_syscall_getaddrinfo_read_ocall = 57,
    attestation_fcn_id_oe_syscall_getaddrinfo_close_ocall = 58,
    attestation_fcn_id_oe_syscall_getnameinfo_ocall = 59,
    attestation_fcn_id_oe_syscall_nanosleep_ocall = 60,
    attestation_fcn_id_oe_syscall_getpid_ocall = 61,
    attestation_fcn_id_oe_syscall_getppid_ocall = 62,
    attestation_fcn_id_oe_syscall_getpgrp_ocall = 63,
    attestation_fcn_id_oe_syscall_getuid_ocall = 64,
    attestation_fcn_id_oe_syscall_geteuid_ocall = 65,
    attestation_fcn_id_oe_syscall_getgid_ocall = 66,
    attestation_fcn_id_oe_syscall_getegid_ocall = 67,
    attestation_fcn_id_oe_syscall_getpgid_ocall = 68,
    attestation_fcn_id_oe_syscall_getgroups_ocall = 69,
    attestation_fcn_id_oe_syscall_uname_ocall = 70,
    attestation_fcn_id_oe_get_supported_attester_format_ids_ocall = 71,
    attestation_fcn_id_oe_get_qetarget_info_ocall = 72,
    attestation_fcn_id_oe_get_quote_ocall = 73,
    attestation_fcn_id_oe_get_quote_verification_collateral_ocall = 74,
    attestation_fcn_id_oe_sgx_get_cpuid_table_ocall = 75,
    attestation_fcn_id_oe_sgx_backtrace_symbols_ocall = 76,
    attestation_fcn_id_oe_sgx_thread_wake_wait_ocall = 77,
    attestation_fcn_id_oe_sgx_wake_switchless_worker_ocall = 78,
    attestation_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 79,
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    oe_syscall_fsync_ocall_args_t* pargs_in = (oe_syscall_fsync_ocall_args_t*)input_buffer;
    oe_syscall_fsync_ocall_args_t* pargs_out = (oe_syscall_fsync_ocall_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = oe_syscall_fsync_ocall(
        pargs_in->fd);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    oe_syscall_fdatasync_ocall_args_t* pargs_in = (oe_syscall_fdatasync_ocall_args_t*)input_buffer;
    oe_syscall_fdatasync_ocall_args_t* pargs_out = (oe_syscall_fdatasync_ocall_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = oe_syscall_fdatasync_ocall(
        pargs_in->fd);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    oe_syscall_fstat_ocall_args_t* pargs_in = (oe_syscall_fstat_ocall_args_t*)input_buffer;
    oe_syscall_fstat_ocall_args_t* pargs_out = (oe_syscall_fstat_ocall_args_t*)output_buffer;
    ...
    /* In-out parameters are copied to output buffer. */
    if (pargs_in->buf)
        OE_SET_OUT_POINTER(buf, sizeof(struct oe_stat_t), struct oe_stat_t*);

    /* Call user function. */
    pargs_out->_retval = oe_syscall_fstat_ocall(
        pargs_in->fd,
        pargs_in->buf);
...
static oe_ocall_func_t __attestation_ocall_function_table[] = {
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               __attestation_ocall_function_table,
               80,
               enclave);
}
